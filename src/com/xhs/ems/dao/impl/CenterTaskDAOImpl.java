...
public class CenterTaskDAOImpl implements CenterTaskDAO {
	...
	public Grid getData(Parameter parameter) {
		String sql = "select pc.姓名 name,pc.homeAddr sickAddress,pc.chiefComplaint sickDescription,e.呼救电话 phone,"
				...
				+ " convert(varchar(20),t.到达医院时刻,120) returnHospitalTime,pc.toAddr toAddress,am.实际标识 carCode,"
				+ "pc.doctor ,pc.nurse , pc.driver ,m.姓名 dispatcher,tr.NameM taskResult from AuSp120.tb_EventV  e "
				...
				+ "full outer join AuSp120.tb_PatientCase pc on am.实际标识=pc.actualSign and t.任务编码=pc.任务编码"
